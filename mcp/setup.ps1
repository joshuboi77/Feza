# Feza MCP Server Setup Script for Windows
# This script installs dependencies and builds the MCP server

Write-Host "Feza MCP Server Setup" -ForegroundColor Cyan
...
Write-Host "1. The Cursor MCP configuration file has been created at:" -ForegroundColor White
Write-Host "   %USERPROFILE%\.cursor\mcp.json" -ForegroundColor Cyan
Write-Host ""
Write-Host "2. Edit the file and add your GitHub token if needed:" -ForegroundColor White
Write-Host "   - Set GH_TOKEN or GITHUB_TOKEN in the env section" -ForegroundColor White
Write-Host ""
